 ...
 */
class getOperateursRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\OperateursRepository' shared autowired service.
     *
     * @return \App\Repository\OperateursRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'OperateursRepository.php';

        return $container->privates['App\\Repository\\OperateursRepository'] = new \App\Repository\OperateursRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
